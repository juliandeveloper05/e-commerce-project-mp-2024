...
const LoginPage = () => {
  ...
  // Optimizado con useCallback para evitar recreación en cada render
  const handleNavigateBack = useCallback(() => {
    try {
      router.push('/productos');
    } catch (error) {
      console.error('Error navegando:', error);
      toast.error('Error al navegar. Por favor intente nuevamente.');
    }
  }, [router]);
          ...
          >
            ...
            <div className="space-y-6">
              <motion.button
                ...
                disabled={isLoading}
                className="group relative flex w-full items-center justify-center gap-3 rounded-full bg-purple-600 px-6 py-4 text-base font-medium text-white shadow-lg transition-all hover:bg-purple-700 disabled:cursor-not-allowed disabled:opacity-50"
              >
